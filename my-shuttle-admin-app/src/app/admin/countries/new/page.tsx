...
const AddCountryPage = () => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect after a short delay or directly
      router.push('/admin/countries'); // Redirect to the list page
      // Optionally refresh data on the target page if needed, though redirect usually handles it
      // router.refresh(); // If staying on the same page or need explicit refresh
